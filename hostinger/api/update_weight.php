...
// CORS para app web e apps nativos (Capacitor, etc.)
$origin = $_SERVER['HTTP_ORIGIN'] ?? '';
if ($origin) {
    // Refletir a origem que chamou (permitindo app web e apps nativos que usam HTTP_ORIGIN)
    header("Access-Control-Allow-Origin: {$origin}");
    header("Vary: Origin");
} else {
    // Fallback genérico (por exemplo, chamadas internas sem Origin)
...
// Pré-flight (OPTIONS) deve responder vazio e encerrar
