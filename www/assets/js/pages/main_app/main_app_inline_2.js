...
(function() {
    ...
    function initMainAppInline2() {
        ...
        function updateWaterDrop(animated = true) {
            ...
            const goalMl = (Number(window.currentWaterGoalMl) > 0) ? Number(window.currentWaterGoalMl) : DEFAULT_WATER_GOAL;
            const percentage = goalMl > 0 ? Math.min(window.currentWater / goalMl, 1) : 0;
